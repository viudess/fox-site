                ...
                <div className="flex justify-center mt-12">
                    <form action="" onSubmit={sendEmail} className="flex flex-col md:w-7/12 w-11/12">
                        ...
                        <div className="flex justify-center mt-3">
                            <button type='submit' value="enviar" className="px-7 py-2 bg-tpg dark:bg-dmnav text-foxus dark:text-nav font-bold rounded-full focus:outline-none text-3xl">Enviar</button>
                        </div>
